        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="auth">
              <ul class="nav flex-column sub-menu">
              <a class="nav-item"><a href="indexP.php" class="nav-link">Mon Accueil <span class="badge badge-pill badge-danger">1</span></a>
              <a class="nav-item"><a href= "administrateur.php"class="nav-link">Afficher Les Utilisateurs</a>
              <a class="nav-item"><a href= "clients.php"class="nav-link"> Afficher Les Clients</a>
